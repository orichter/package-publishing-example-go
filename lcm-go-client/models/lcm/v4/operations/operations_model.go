...
package operations
import (
  import3 "github.com/orichter/package-publishing-example-go/lcm-go-client/v4/models/common/v1/response"
  "encoding/json"
  "errors"
  "fmt"
  import2 "github.com/orichter/package-publishing-example-go/lcm-go-client/v4/models/lcm/v4/error"
  import1 "github.com/orichter/package-publishing-example-go/lcm-go-client/v4/models/prism/v4/config"
)
