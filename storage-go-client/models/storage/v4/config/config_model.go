...
import (
	...
	"errors"
	"fmt"
	import2 "github.com/orichter/package-publishing-example-go/storage-go-client/v4/models/common/v1/config"
	import1 "github.com/orichter/package-publishing-example-go/storage-go-client/v4/models/common/v1/response"
	import4 "github.com/orichter/package-publishing-example-go/storage-go-client/v4/models/prism/v4/config"
	import3 "github.com/orichter/package-publishing-example-go/storage-go-client/v4/models/storage/v4/error"
)
