...
import (
	...
	"errors"
	"fmt"
	import1 "github.com/orichter/package-publishing-example-go/networking-go-client/v4/models/common/v1/config"
	import2 "github.com/orichter/package-publishing-example-go/networking-go-client/v4/models/common/v1/response"
	import3 "github.com/orichter/package-publishing-example-go/networking-go-client/v4/models/networking/v4/error"
	import4 "github.com/orichter/package-publishing-example-go/networking-go-client/v4/models/prism/v4/config"
)
