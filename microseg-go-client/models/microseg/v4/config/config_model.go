...
import (
	...
	import3 "github.com/orichter/package-publishing-example-go/microseg-go-client/v4/models/microseg/v4/error"
	import4 "github.com/orichter/package-publishing-example-go/microseg-go-client/v4/models/prism/v4/config"
	"time"
)
