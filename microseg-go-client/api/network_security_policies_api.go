...
import (
	...
	import2 "github.com/orichter/package-publishing-example-go/microseg-go-client/v4/models/common/v1/config"
	import3 "github.com/orichter/package-publishing-example-go/microseg-go-client/v4/models/common/v1/response"
	import1 "github.com/orichter/package-publishing-example-go/microseg-go-client/v4/models/microseg/v4/config"
	"net/http"
	"net/url"
	"os"
	"strings"
