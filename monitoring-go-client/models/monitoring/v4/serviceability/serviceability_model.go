...
import (
	...
	"errors"
	"fmt"
	import4 "github.com/orichter/package-publishing-example-go/monitoring-go-client/v4/models/common/v1/config"
	import2 "github.com/orichter/package-publishing-example-go/monitoring-go-client/v4/models/common/v1/response"
	import1 "github.com/orichter/package-publishing-example-go/monitoring-go-client/v4/models/monitoring/v4/common"
	import3 "github.com/orichter/package-publishing-example-go/monitoring-go-client/v4/models/monitoring/v4/error"
	import5 "github.com/orichter/package-publishing-example-go/monitoring-go-client/v4/models/prism/v4/config"
	"time"
)
