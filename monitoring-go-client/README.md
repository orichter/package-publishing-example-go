...
```shell
$ go get github.com/orichter/package-publishing-example-go/monitoring-go-client/v4/...@v4.0.1
```
...
require (
	github.com/orichter/package-publishing-example-go/monitoring-go-client/v4 v4.0.1
)
```
