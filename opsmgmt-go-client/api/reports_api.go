...
import (
	"encoding/json"
	"github.com/orichter/package-publishing-example-go/opsmgmt-go-client/v4/client"
	import3 "github.com/orichter/package-publishing-example-go/opsmgmt-go-client/v4/models/common/v1/config"
	import4 "github.com/orichter/package-publishing-example-go/opsmgmt-go-client/v4/models/common/v1/response"
	import1 "github.com/orichter/package-publishing-example-go/opsmgmt-go-client/v4/models/opsmgmt/v4/config"
	import2 "github.com/orichter/package-publishing-example-go/opsmgmt-go-client/v4/models/opsmgmt/v4/content"
	"net/http"
	"net/url"
	"strings"
)
