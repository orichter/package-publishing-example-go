...
```shell
$ go get github.com/orichter/package-publishing-example-go/volumes-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/orichter/package-publishing-example-go/volumes-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/orichter/package-publishing-example-go/volumes-go-client/v4 latest
)
```
...
require (
	github.com/orichter/package-publishing-example-go/volumes-go-client/v4 v4.0.1-beta.1
)
```
...
```go
import (
	"github.com/orichter/package-publishing-example-go/volumes-go-client/v4/client"
)
var (
...
import (
	"github.com/orichter/package-publishing-example-go/volumes-go-client/v4/client"
	"github.com/orichter/package-publishing-example-go/volumes-go-client/v4/api"
)
