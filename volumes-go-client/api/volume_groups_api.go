...
import (
	...
	import2 "github.com/orichter/package-publishing-example-go/volumes-go-client/v4/models/common/v1/stats"
	import1 "github.com/orichter/package-publishing-example-go/volumes-go-client/v4/models/volumes/v4/config"
	import3 "github.com/orichter/package-publishing-example-go/volumes-go-client/v4/models/volumes/v4/stats"
	"net/http"
	"net/url"
	"strings"
	"time"
