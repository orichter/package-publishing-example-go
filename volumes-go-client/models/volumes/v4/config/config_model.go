...
import (
	...
	"errors"
	"fmt"
	import4 "github.com/orichter/package-publishing-example-go/volumes-go-client/v4/models/common/v1/config"
	import2 "github.com/orichter/package-publishing-example-go/volumes-go-client/v4/models/common/v1/response"
	import3 "github.com/orichter/package-publishing-example-go/volumes-go-client/v4/models/prism/v4/config"
	import1 "github.com/orichter/package-publishing-example-go/volumes-go-client/v4/models/volumes/v4/error"
)
