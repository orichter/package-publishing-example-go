...
```shell
$ go get github.com/orichter/package-publishing-example-go/vmm-go-client/v4/...@v4.0.3-alpha.1
```
...
require (
	github.com/orichter/package-publishing-example-go/vmm-go-client/v4 v4.0.3-alpha.1
)
```
