...
```shell
$ go get github.com/nutanix-release-engineering/experiments-nutanix-sdk-golang/vmm-go-client/v4
```

##### Install a specific version

```shell
$ go get github.com/nutanix-release-engineering/experiments-nutanix-sdk-golang/vmm-go-client/v4/...@v4.0.1-alpha.1
```
...
require (
	github.com/nutanix-release-engineering/experiments-nutanix-sdk-golang/vmm-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-release-engineering/experiments-nutanix-sdk-golang/vmm-go-client/v4 v4.0.1-alpha.1
)
```
...
import (
	"github.com/nutanix-release-engineering/experiments-nutanix-sdk-golang/vmm-go-client/v4/client"
	"github.com/nutanix-release-engineering/experiments-nutanix-sdk-golang/vmm-go-client/v4/api"
)
...
extId := "^b1Fac38A-ad2b-cFA7-bdB2-8B2bADeD4E8e$"
