...
```shell
$ go get github.com/nutanix-core/ntnx-api-golang-sdk-external/iam-go-client/v4
```

##### Install a specific version

```shell
$ go get github.com/nutanix-core/ntnx-api-golang-sdk-external/iam-go-client/v4/...@v4.0.1-alpha.1
```
...
require (
	github.com/nutanix-core/ntnx-api-golang-sdk-external/iam-go-client/v4 latest
)
```
...
require (
	github.com/nutanix-core/ntnx-api-golang-sdk-external/iam-go-client/v4 v4.0.1-alpha.1
)
```
...
import (
	"github.com/nutanix-core/ntnx-api-golang-sdk-external/iam-go-client/v4/client"
	"github.com/nutanix-core/ntnx-api-golang-sdk-external/iam-go-client/v4/api"
)
