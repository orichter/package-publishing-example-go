...
import (
	...
	"errors"
	"fmt"
	import5 "github.com/orichter/package-publishing-example-go/lifecycle-go-client/v4/models/common/v1/config"
	import2 "github.com/orichter/package-publishing-example-go/lifecycle-go-client/v4/models/common/v1/response"
	import1 "github.com/orichter/package-publishing-example-go/lifecycle-go-client/v4/models/lifecycle/v4/common"
	import4 "github.com/orichter/package-publishing-example-go/lifecycle-go-client/v4/models/lifecycle/v4/error"
	import3 "github.com/orichter/package-publishing-example-go/lifecycle-go-client/v4/models/prism/v4/config"
	"time"
)
