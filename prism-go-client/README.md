...
```shell
$ go get github.com/orichter/package-publishing-example-go/prism-go-client/v4
```

##### Install a specific version

```shell
$ go get github.com/orichter/package-publishing-example-go/prism-go-client/v4/...@v4.0.1-alpha.1
```
...
require (
	github.com/orichter/package-publishing-example-go/prism-go-client/v4 latest
)
```
...
require (
	github.com/orichter/package-publishing-example-go/prism-go-client/v4 v4.0.1-alpha.1
)
```
...
import (
	"github.com/orichter/package-publishing-example-go/prism-go-client/v4/client"
	"github.com/orichter/package-publishing-example-go/prism-go-client/v4/api"
)
