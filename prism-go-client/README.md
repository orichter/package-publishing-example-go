...
```shell
$ go get github.com/orichter/package-publishing-example-go/prism-go-client/v4/...@v4.0.2-alpha.1
```
...
require (
	github.com/orichter/package-publishing-example-go/prism-go-client/v4 v4.0.2-alpha.1
)
```
