...
import (
	"encoding/json"
	"github.com/orichter/package-publishing-example-go/clustermgmt-go-client/v4/client"
	import1 "github.com/orichter/package-publishing-example-go/clustermgmt-go-client/v4/models/clustermgmt/v4/config"
	import2 "github.com/orichter/package-publishing-example-go/clustermgmt-go-client/v4/models/clustermgmt/v4/operations"
	import3 "github.com/orichter/package-publishing-example-go/clustermgmt-go-client/v4/models/clustermgmt/v4/stats"
	import4 "github.com/orichter/package-publishing-example-go/clustermgmt-go-client/v4/models/common/v1/stats"
	"net/http"
	"net/url"
	"strings"
	"time"
