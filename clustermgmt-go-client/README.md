...
```shell
$ go get github.com/orichter/package-publishing-example-go/clustermgmt-go-client/v4/...@v4.0.1-beta.2
```
...
require (
	github.com/orichter/package-publishing-example-go/clustermgmt-go-client/v4 v4.0.1-beta.2
)
```
