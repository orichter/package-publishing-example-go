...
import (
	...
	import1 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/common/v1/stats"
	import2 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/files/v4/stats"
	"net/http"
	"net/url"
	"strings"
	"time"
