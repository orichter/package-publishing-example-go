...
import (
  "bytes"
  import5 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/common/v1/config"
  import2 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/common/v1/response"
  "encoding/json"
  "errors"
  import1 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/files/v4/config"
  import3 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/files/v4/error"
  "fmt"
  import6 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/prism/v4/config"
  import4 "github.com/orichter/package-publishing-example-go/files-go-client/v4/models/storage/v4/config"
)
